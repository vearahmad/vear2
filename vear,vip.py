...
#                print(f'{P}JANGAN GUNAKAN AKUN PRIBADI') 
		...
		with requests.Session() as r:
			...
			try:
				...
				r.headers.update({'authority': 'mbasic.facebook.com',
...
def menu(my_name,my_id):
	...
	if RAF_MKZ in ['1','01']:
		...
		os.system("xdg-open https://t.me/@FB._ACC1")
...
def result():
	...
	if kz in ['2','02']:
		try:vin = os.listdir('𝑪𝒑_vear,VIP❌')
		...
		try:vin = os.listdir('𝒐𝒌_vear,VIP✅')
		except FileNotFoundError:
			print(' ╰─  File Tidak Di Temukan ')
			time.sleep(4)
			back()
...
def passwrd():
	...
	print(f'  [{h}•{x}]{h} Oᴋ_vear,VIP✅ : {h}%s '%(ok))
	print(f'{x}  [{h}•{x}]{k} Cᴘ_vear,VIP❌ : {k}%s{x} '%(cp))
...
if __name__=='__main__':
	...
	try:os.mkdir('vear,VIP OK🤑') 
	except:pass
	try:os.mkdir('vear,VIP CP😒')
	except:pass
